        ...
        <>
          <div className="container-registro Background-registro">
            ...
            >
             ...
             <Form.Group className="mb-3" controlId="formRegistroTelefono">
              <Form.Label className="sub_title-registro">Número de Contacto:</Form.Label>
              <Form.Control
                type="number"
          ...
          <Col md={4}>
            <Form.Group className="mb-3" controlId="formFechaEntrada">
              <Form.Label className="sub_title-registro">Fecha de Entrada</Form.Label>
              <DatePicker
                selected={startDate}
          ...
          <Col md={4}>
            <Form.Group className="mb-3" controlId="formFechaSalida">
              <Form.Label className="sub_title-registro">Fecha de Salida</Form.Label>
              <DatePicker
                selected={endDate}
          ...
          <Col md={4}>
            <Form.Group className="mb-3" controlId="formFechaSalida">
              <Form.Label className="sub_title-registro">Total de días</Form.Label>
              <Form.Control
                type="number"
                placeholder="Ej: 7"
                {...register("TotalDeDias", {
                  ...
                  pattern: {
                    value: /^[0-9]{3}$/,
                    message:
                      "Los dias no pueden superar los 3 dígitos)",
                  },
                })}
              />
              <Form.Text className="text-danger">

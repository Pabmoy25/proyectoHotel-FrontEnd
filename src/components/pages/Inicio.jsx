        ...
        <div className="containerInicio" id="containerInicio" >
            ...
            <div className="form-container sing-in">
                <form action="#">
                    ...
                    <input type="email" placeholder="Email"/>
                    <input type="password" placeholder="Contraseña" />
                    <a href="#" className="fp">¿Olvidate tu Contraseña?</a>
            ...
            <div className="toggle-container">
                <div className="toggle">
                    ...
                    <div className="toggle-panel toggle-right">
                        <h1>Hola Amigo!</h1>
                        <p>
Regístrese con sus datos personales para utilizar todas las funciones del sitio</p>
                        <button className="hidden" id="registrer">Registrarse</button>
                    </div>

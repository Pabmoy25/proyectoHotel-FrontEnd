...
const SobreNosotros = () => {
    return (
        <>
         <section>
            <h1 class="mt-4 tituloAdmin text-center">Acerca de Nosotros</h1>
        </section>
        <section class="container-fluid">
        <div class="row">
          <div class="col-md-12 col-lg-12 col-sm-12 mb-sm-4">
              <h2 class="texto-principal">Bienvenido a Haku Wasi - Tu Refugio de Cinco Estrellas</h2>
              <p>
